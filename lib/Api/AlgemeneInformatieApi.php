...
class AlgemeneInformatieApi
{
     ...
     * @return \Kadaster\BagApiClient\Model\APIInfo
     */
     ...
     * @throws \Kadaster\BagApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Kadaster\BagApiClient\Model\APIInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInfoWithHttpInfo()
    {
        $returnType = '\Kadaster\BagApiClient\Model\APIInfo';
