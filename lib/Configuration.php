...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.bag.kadaster.nl/lvbag/individuelebevragingen/v2';
    ...
    {
        $report  = 'PHP SDK (Kadaster\BagApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2.9.2' . PHP_EOL;
