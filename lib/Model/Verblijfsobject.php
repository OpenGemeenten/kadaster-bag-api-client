 ...
 *
 * @category Class
 * @description Een Verblijfsobject is de kleinste binnen een of meer panden gelegen en voor woon-, bedrijfsmatige, of recreatieve doeleinden geschikte eenheid van gebruik die ontsloten wordt via een eigen afsluitbare toegang vanaf de openbare weg, een erf of een gedeelde verkeersruimte, onderwerp kan zijn van goederenrechtelijke rechtshandelingen en in functioneel opzicht zelfstandig is.  **heeftAlsHoofdAdres**: Een adresseerbaar object heeft als hoofadres een  nummeraanduiding.  Deze property bevat de identificatie van de nummeraanduiding die het  hoofdadres is van het adresseerbare object.  **geometrie**: De minimaal tweedimensionale geometrische representatie van  een verblijfsobject.  **status**: De fase van de levenscyclus van een verblijfsobject, waarin het  betreffende verblijfsobject zich bevindt.  **geconstateerd**: Een aanduiding waarmee kan worden aangegeven dat een  object in de registratie is opgenomen als gevolg van een feitelijke  constatering, zonder dat er op het moment van opname sprake was van een  regulier brondocument voor deze opname.  **voorkomen**: De toestand van een object in de administratieve  werkelijkheid, zoals beschreven met de eigenschappen van dit object  waarover gegevens geregistreerd worden, waarbij de gegevens gedurende een  bepaalde periode gelijk zijn in de (basis) registratie.
 * @package  Kadaster\BagApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Verblijfsobject extends AdresseerbaarObject 
{
    ...
    protected static $swaggerTypes = [
        'identificatie' => '\Kadaster\BagApiClient\Model\VerblijfsobjectIdentificatie',
        'domein' => 'string',
        'geometrie' => '\Kadaster\BagApiClient\Model\PuntOfVlak',
        'gebruiksdoelen' => '\Kadaster\BagApiClient\Model\Gebruiksdoel[]',
        'oppervlakte' => 'int',
        'status' => '\Kadaster\BagApiClient\Model\StatusVerblijfsobject',
        ...
        'maakt_deel_uit_van' => '\Kadaster\BagApiClient\Model\PandIdentificatie[]'
    ];
     ...
     * Gets identificatie
     *
     * @return \Kadaster\BagApiClient\Model\VerblijfsobjectIdentificatie
     */
     ...
     * Sets identificatie
     *
     * @param \Kadaster\BagApiClient\Model\VerblijfsobjectIdentificatie $identificatie identificatie
     *
     * @return $this
     */
     ...
     * Sets geometrie
     *
     * @param \Kadaster\BagApiClient\Model\PuntOfVlak $geometrie geometrie
     *
     * @return $this
     */
     ...
     * Sets oppervlakte
     *
     * @param int $oppervlakte De gebruiksoppervlakte van een verblijfsobject in gehele vierkante meters.
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \Kadaster\BagApiClient\Model\StatusVerblijfsobject
     */
     ...
     * Sets status
     *
     * @param \Kadaster\BagApiClient\Model\StatusVerblijfsobject $status status
     *
     * @return $this
     */
     ...
     *
     * @param \Kadaster\BagApiClient\Model\PandIdentificatie[] $maakt_deel_uit_van Een verblijfsobject maakt onderdeel uit van een pand.  Deze property bevat de identificaties van de panden waar het verblijfsobject onderdeel van uitmaakt.
     *
     * @return $this
     */
