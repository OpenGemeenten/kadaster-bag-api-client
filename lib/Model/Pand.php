...
class Pand implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'identificatie' => '\Kadaster\BagApiClient\Model\PandIdentificatie',
        'domein' => 'string',
        'geometrie' => '\Kadaster\BagApiClient\Model\Surface',
        'oorspronkelijk_bouwjaar' => 'string',
        'status' => '\Kadaster\BagApiClient\Model\StatusPand',
     ...
     * Sets identificatie
     *
     * @param \Kadaster\BagApiClient\Model\PandIdentificatie $identificatie identificatie
     *
     * @return $this
     */
     ...
     *
     * @param string $oorspronkelijk_bouwjaar De aanduiding van het jaar waarin een pand oorspronkelijk als bouwkundig  gereed is of zal worden opgeleverd.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param \Kadaster\BagApiClient\Model\StatusPand $status status
     *
     * @return $this
     */
