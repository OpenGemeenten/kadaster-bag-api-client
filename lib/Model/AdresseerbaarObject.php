 ...
 *
 * @category Class
 * @description Abstract type adresseerbaar object  **heeftAlsHoofdAdres**: Een adresseerbaar object heeft als hoofadres een  nummeraanduiding.  Deze property bevat de identificatie van de nummeraanduiding die het  hoofdadres is van het adresseerbare object.
 * @package  Kadaster\BagApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdresseerbaarObject implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'heeft_als_hoofd_adres' => '\Kadaster\BagApiClient\Model\NummeraanduidingIdentificatie',
        'heeft_als_neven_adres' => '\Kadaster\BagApiClient\Model\NummeraanduidingIdentificatie[]',
        'type' => '\Kadaster\BagApiClient\Model\TypeAdresseerbaarObject'
    ];
     ...
     *
     * @param \Kadaster\BagApiClient\Model\NummeraanduidingIdentificatie $heeft_als_hoofd_adres heeft_als_hoofd_adres
     *
     * @return $this
     */
     ...
     *
     * @param \Kadaster\BagApiClient\Model\NummeraanduidingIdentificatie[] $heeft_als_neven_adres Een adresseerbaar object heeft als nevenadres een nummeraanduiding.  Deze property bevat de identificatie van de nummeraanduiding die een nevenadres is van het adresseerbare object.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param \Kadaster\BagApiClient\Model\TypeAdresseerbaarObject $type type
     *
     * @return $this
     */
