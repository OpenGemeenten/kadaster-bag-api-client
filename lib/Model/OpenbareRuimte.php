 ...
 *
 * @category Class
 * @description Een Openbare ruimte is een door het bevoegde gemeentelijke orgaan als zodanig  aangewezen en van een naam voorziene buitenruimte die binnen één woonplaats  is gelegen.  **type**: De aard van de als zodanig benoemde openbare ruimte.  **status**: De fase van de levenscyclus van een openbare ruimte, waarin de  betreffende openbare ruimte zich bevindt.  **geconstateerd**: Een aanduiding waarmee kan worden aangegeven dat een  object in de registratie is opgenomen als gevolg van een feitelijke  constatering, zonder dat er op het moment van opname sprake was van een  regulier brondocument voor deze opname.  **voorkomen**: De toestand van een object in de administratieve  werkelijkheid, zoals beschreven met de eigenschappen van dit object waarover  gegevens geregistreerd worden, waarbij de gegevens gedurende een bepaalde  periode gelijk zijn in de (basis) registratie.  **ligtIn**: Een openbare ruimte ligt in een woonplaats. Deze property bevat de identificatie van de woonplaats waar de openbare ruimte in ligt.
 * @package  Kadaster\BagApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OpenbareRuimte implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'identificatie' => '\Kadaster\BagApiClient\Model\OpenbareRuimteIdentificatie',
        'domein' => 'string',
        'naam' => 'string',
        'type' => '\Kadaster\BagApiClient\Model\TypeOpenbareRuimte',
     ...
     * Sets identificatie
     *
     * @param \Kadaster\BagApiClient\Model\OpenbareRuimteIdentificatie $identificatie identificatie
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Kadaster\BagApiClient\Model\TypeOpenbareRuimte
     */
     ...
     * Sets type
     *
     * @param \Kadaster\BagApiClient\Model\TypeOpenbareRuimte $type type
     *
     * @return $this
     */
